...
(function () {
    ...
    async function actualizarTarea(tarea) {
        ...
        try {
            ...
            const url = 'http://localhost:6969/api/tarea/actualizar';
...
type="text"
name="tarea"
placeholder="${editar ? 'Editar Tarea' : 'Añadir Tarea al Proyecto Actual'}"
id="tarea"
...
<button type="button" class="cerrar-modal">Cancelar</button>
    ...
    async function eliminarTarea(tarea) {
        ...
        try {
            const url = 'http://localhost:6969/api/tarea/eliminar';
            const respuesta = await fetch(url,{
                method: 'POST',
                body: datos
            });
